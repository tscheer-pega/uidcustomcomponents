...
export default PegaUidPhone;
declare function PegaUidPhone(props: any): import('react/jsx-runtime').JSX.Element;
declare namespace PegaUidPhone {
  ...
  namespace propTypes {
    ...
    const datasource_1: PropTypes.Requireable<{
      [x: string]: any;
    }>;
